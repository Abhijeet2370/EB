...
<div class="card flex-item" style="border-left-color:#753a88 ; border-bottom-color:#753a88 ;  border-top-color:#cc2b5e ;  border-right-color:#cc2b5e ;">
  <img src="images/post_count.jpg" width="250px" class="card-img-top" alt="...">
...
<div class="card flex-item" style="border-left-color:#185a9d ; border-bottom-color:#185a9d ;  border-top-color:#43cea2 ;  border-right-color:#43cea2 ;">
  <img src="images/comment_count.jpg" width="250px" class="card-img-top" alt="...">
...
<div class="card flex-item" style="border-left-color:#dd2476 ; border-bottom-color:#dd2476 ;  border-top-color:#ff512f ;  border-right-color:#ff512f ;">
  <img src="images/categories_count.jpg" width="250px" class="card-img-top" alt="...">
